local specializedItemTypeMap = {
    ...
    ["jewelrycrafting_raw_trait"] = SPECIALIZED_ITEMTYPE_JEWELRY_RAW_TRAIT,
    ["jewelrycrafting_trait"] = SPECIALIZED_ITEMTYPE_JEWELRY_TRAIT,
...
local itemTypeMap = {
    ...
    ["jewelrycrafting_raw_trait"] = ITEMTYPE_JEWELRY_RAW_TRAIT,
    ["jewelrycrafting_trait"] = ITEMTYPE_JEWELRY_TRAIT,
